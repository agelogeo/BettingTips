...
// Obtain the FirebaseAnalytics instance.
        ...
        String response = CallHolder.getTameiarxis_old();
        ...
        try {
            if(response==null)
                ...
                if (!response.contains("The coordinates or dimensions of the range are invalid.")) {
                    ...
                    final JSONArray results = (JSONArray) jsonResult.get(getString(R.string.tameiarxis_history));
                    int counter = 0;
            ...
            TameiarxisOldTipsFragment.this.getActivity().finish();
            e.printStackTrace();
        } catch (Exception e){
            System.out.println("ERROR : onPostExecute");
            TameiarxisOldTipsFragment.this.getActivity().finish();
